...
class SearchFormView(FormView):
    ...
    def form_valid(self, form) :
        ...
        if schTitle:
            post_list_sub += Post.objects.filter(
        ...
        context['schTitle'] = schTitle
        context['schDescription'] = schDescription
        context['schContent'] = schContent
        context['schTag'] = schTag
        context['object_list'] = post_list
        context['object_list_sub'] = post_list_sub
